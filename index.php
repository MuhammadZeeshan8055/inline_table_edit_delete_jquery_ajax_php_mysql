            ...
            <tr id="<?php echo $row['id']; ?>">
                ...
                <td>
                    ...
                    <input class="form-control editInput first_name" type="text" name="first_name"
                        value="<?php echo $row['first_name']; ?>" style="display: none;">
                </td>
                <td>
                    ...
                    <input class="form-control editInput last_name" type="text" name="last_name"
                        value="<?php echo $row['last_name']; ?>" style="display: none;">
                </td>
                <td>
                    <span class="editSpan email"><?php echo $row['email']; ?></span>
                    <input class="form-control editInput email" type="text" name="email"
                ...
                <td>
                    <button type="button" class="btn btn-default editBtn"><i class="pencil"></i>Edit</button>
                    <button type="button" class="btn btn-default deleteBtn"><i class="trash"></i>Delete</button>
